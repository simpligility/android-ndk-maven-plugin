...
public class MakefileHelper
{
     ...
     */
    public MakefileHelper( Log log, ArtifactResolverHelper artifactResolverHelper, ArtifactHandler harHandler, File unpackedApkLibsDirectory, File ndkBuildDirectory )
    {
        this.log = log;
            ...
            throws IOException, MojoExecutionException
    {
        ...
        if ( ! artifacts.isEmpty() )
        {
            ...
            {
                final String architecture = NativeHelper.extractArchitectureFromArtifact( artifact, defaultNDKArchitecture );
                ...
                if ( useHeaderArchives )
                {
                    try
                    {
                        ...
                        Artifact harArtifact = new DefaultArtifact( artifact.getGroupId(), artifact.getArtifactId(), artifact.getVersion(), artifact.getScope(),
