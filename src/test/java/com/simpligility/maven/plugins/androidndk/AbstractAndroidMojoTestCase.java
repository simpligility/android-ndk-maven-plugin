...
import com.simpligility.maven.plugins.androidndk.standalonemojos.MojoProjectStub;

public abstract class AbstractAndroidMojoTestCase<T extends AbstractMojo> extends AbstractMojoTestCase {
     ...
     * , configure it from the <code>plugin-config.xml</code> and return the created Mojo.
     * <p>
